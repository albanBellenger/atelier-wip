...
class LlmRegistryModelEntry(BaseModel):
    """One chat model on a provider row, with optional LiteLLM-derived context metadata."""
    ...
    def from_legacy_string(cls, model_id: str) -> LlmRegistryModelEntry:
        return cls(id=model_id.strip(), max_context_tokens=None, context_metadata_source="unknown")
