...
from app.schemas.admin_console import StudioGitLabOut, StudioGitLabPatch, StudioToolAdminPatch
...
class StudioToolAdminService:
    ...
    async def get_gitlab(self, studio: Studio) -> StudioGitLabOut:
        return StudioGitLabOut(
    ...
    async def patch_gitlab(self, studio: Studio, body: StudioGitLabPatch) -> StudioGitLabOut:
    ...
    async def patch_budget(self, studio: Studio, body: StudioToolAdminPatch) -> None:
