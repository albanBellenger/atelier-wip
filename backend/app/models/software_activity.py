"""Audit-style timeline rows for the software dashboard."""
...
class SoftwareActivityEvent(Base):
    __tablename__ = "software_activity_events"
    ...
    software = relationship("Software", back_populates="activity_events")
